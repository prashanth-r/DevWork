...
# Run the OLH load
export OLH_HOME=/users/k228680/oraloader-2.3.1-h2

CUSTOM_JAR=/users/k228680/oracle_utils/customFormat.jar
...
CUSTOM_JAR=/users/k228680/oracle_utils/getLogInfo.jar
